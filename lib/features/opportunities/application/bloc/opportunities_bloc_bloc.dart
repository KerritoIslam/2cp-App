...
class OpportunitiesBloc
    extends Bloc<OpportunitiesBlocEvent, OpportunitiesBlocState> {
...
class OpportunitiesSavedBloc
    extends Bloc<OpportunitiesSavedEvent, OpportunitiesSavedState> {
  final OpportunityRepository repository;
  ...
  OpportunitiesSavedBloc(this.repository) : super(OpportunitiesSavedInitial()) {
    ...
    on<LoadSavedOpportunitiesEvent>((event, emit) async {
      ...
      result.fold((failure) {
        ...
        savedOpportunities = List<Opportunity>.from(savedOpportunities)
          ..addAll(oppList);
