...
mixin _$ChatMessageModel {
  ...
  String get sent_time => throw _privateConstructorUsedError;
...
abstract class $ChatMessageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String message, int sender, String sent_time});
}
...
class _$ChatMessageModelImpl implements _ChatMessageModel {
  ...
  @override
  String toString() {
    return 'ChatMessageModel(id: $id, message: $message, sender: $sender, sent_time: $sent_time)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, message, sender, sent_time);
...
abstract class _ChatMessageModel implements ChatMessageModel {
  const factory _ChatMessageModel(
      ...
      required final String sent_time}) = _$ChatMessageModelImpl;
