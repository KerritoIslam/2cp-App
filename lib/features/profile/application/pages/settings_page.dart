  ...
  children: [
    ...
    AnimatedSwitcher(
      ...
      child: SvgPicture.asset(
        isDarkMode ? 'assets/icons/darkMode_dark.svg' : 'assets/icons/darkMode.svg',
        key: ValueKey(isDarkMode), // Important for AnimatedSwitcher to detect changes
      ),
    ),

    SizedBox(width: 20.w),
    Text('Dark Mode', style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: Theme.of(context).secondaryHeaderColor)),
                  Spacer(),
    Switch(
    activeColor: Theme.of(context).primaryColor,
                    trackOutlineColor:WidgetStatePropertyAll( Theme.of(context).secondaryHeaderColor.withOpacity(0.4)),
...
shrinkWrap: true,
                ...
                children: [
                    SizedBox(width: 20.w,),
    SvgPicture.asset(
        isDarkMode ? pageElements[idx]['iconDark']??"": pageElements[idx]['icon']??"",
        key: ValueKey(isDarkMode), // Important for AnimatedSwitcher to detect changes
      ),
    

    SizedBox(width: 20.w),
    Text(pageElements[idx]['name']??"", style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: Theme.of(context).secondaryHeaderColor)),

                ],
              ), separatorBuilder: (ctx,idx)=>SizedBox(height: 50.h,), itemCount: pageElements.length),
